    ...
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8">
        ...
        <div className="relative">
          <div className="absolute inset-0 bg-linear-to-t from-orange-50 via-transparent to-transparent pointer-events-none z-10" />
      ...
      <div className="mt-24">
        <Card className="bg-linear-to-r from-orange-100 to-amber-100">
          <CardContent className="p-12 text-center">
            ...
            <Button size="lg" variant="loginButton" className="animate-bounce">
